				...
				headers: [
					{
						...
						value: `frame-ancestors 'self' https://plugins-cdn.datocms.com https://dashboard.datocms.com ${process.env.NEXT_PUBLIC_DATOCMS_BASE_EDITING_URL} ${process.env.NEXT_PUBLIC_SITE_URL}`,
					},
				],
			},
			{
